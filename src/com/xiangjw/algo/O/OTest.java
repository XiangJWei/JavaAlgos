...
public class OTest {
	...
	public static void main(String []args) {
		int n = 100000;
		{
			...
			System.out.println("cal1---n：" + n + "结果：" + sum + " 耗时" + (after - before) + "ms");
		}
		{
			long before = System.currentTimeMillis();
			long sum = cal2(n);
			long after = System.currentTimeMillis();
			System.out.println("cal2---n：" + n + " 结果：" + sum + " 耗时" + (after - before) + "ms");
		}
		{
			long before = System.currentTimeMillis();
			long sum = cal3(n);
			long after = System.currentTimeMillis();
			System.out.println("cal3---n：" + n + " 结果：" + sum + " 耗时" + (after - before) + "ms");
		}
		{
			long before = System.currentTimeMillis();
			long sum = cal4(n);
			long after = System.currentTimeMillis();
			System.out.println("cal4---n：" + n + " 结果：" + sum + " 耗时" + (after - before) + "ms");
		}
		{
			long before = System.currentTimeMillis();
			long sum = cal5(n);
			long after = System.currentTimeMillis();
			System.out.println("cal5---n：" + n + " 结果：" + sum + " 耗时" + (after - before) + "ms");
		}
		{
			long before = System.currentTimeMillis();
			long sum = cal6(n , n);
			long after = System.currentTimeMillis();
			System.out.println("cal6---n：" + n + " 结果：" + sum + " 耗时" + (after - before) + "ms");
		}
		{
			long before = System.currentTimeMillis();
			long sum = cal7(n , n);
			long after = System.currentTimeMillis();
			System.out.println("cal7---n：" + n + " 结果：" + sum + " 耗时" + (after - before) + "ms");
		}
	}
}
