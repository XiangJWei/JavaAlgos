 ...
 * 分两种情况：
 * 不考虑重复元素时的简单二分查找
 * 考虑重复元素的变种二分查找：查找第一个值等于给定值的元素、查找最后一个值等于给定值的元素、查找第一个大于等于给定值的元素、查找最后一个小于等于给定值的元素
 * 
 * @author xiangjw
 *
 */
public class SearchTest {
	...
	/**
	 * 查找第一个值等于给定值的元素,指的是数组顺序上的第一个，而不是时间上的第一个
	 * 适用于存在重复元素时
	 * @return
	 */
	...
	/**
	 * 查找最后一个值等于给定值的元素,指的是数组顺序上的最后一个，而不是时间上的最后一个
	 * 适用于存在重复元素时
	 * @return
	 */
