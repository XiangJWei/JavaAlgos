...
![数组](http://q0478samy.bkt.clouddn.com/javaalgos/1.jpg "数组")
   2. linkedlist链表
...
![链表 vs 数组](http://q0478samy.bkt.clouddn.com/javaalgos/2.jpg "链表 vs 数组")
![跳表](http://q0478samy.bkt.clouddn.com/javaalgo/3.jpg "跳表")
   3. stack栈
...
![栈](http://q0478samy.bkt.clouddn.com/javaalgos/4.jpg "栈")
   4. queue队列
      + ArrayQuene利用简单数组实现队列功能，动态扩容，存在内存浪费。
      + ArrayCircleQueue利用数组实现一个容量固定的循环队列。
      + LinkedListQueue利用链表实现一个队列。
![队列 vs 栈](http://q0478samy.bkt.clouddn.com/javaalgos/5.jpg "队列 vs 栈")
   5. tree二叉树
...
![二叉树](http://q0478samy.bkt.clouddn.com/javaalgos/6.jpg "二叉树")
![二叉查找树](http://q0478samy.bkt.clouddn.com/javaalgos/7.jpg "二叉查找树")
   6. heap堆
      + CustomHeap实现了一个大顶堆，并封装其常用操作。常用于查找topN等（~~后续会实现其算法场景~~）。
![堆](http://q0478samy.bkt.clouddn.com/javaalgos/8.jpg "堆")
   7. graph图
      + CustomGraph基于数组加链表实现一个无向图，并实现了如下常用了算法场景。
         - 深度优先搜索；
         - 广度优先搜索。                                                               
![图](http://q0478samy.bkt.clouddn.com/javaalgos/9.jpg "图")
   8. hash散列表
      + CustomHashTable封装简单的hashmap，实现常用put、get、remove操作。含数组、链表、散列表、跳表的插入查找性能对比。                       
![散列表](http://q0478samy.bkt.clouddn.com/javaalgos/10.jpg "散列表")
3. 常用算法部分（algo包）
   1. O实现复杂度分析 
